...
static pthread_mutex_t  mutex_phase_a = PTHREADS_MUTEX_INITIALIZER ;
static pthread_mutex_t  mutex_phase_b = PTHREADS_MUTEX_INITIALIZER ;
...
void   GPIO_READ(char g_Datas[TYPES_DATAS_NB_LIGNES][TYPES_DATAS_NB_COLONNES][CONFIG_TAILLE_BUFFER]) ;
