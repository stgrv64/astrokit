...
int domoon(TOPOCENTRIC *infos)
{
	...
	*/
	...
	/*
	Trace1("Geometric lon %.3f deg, lat %.3f deg, rad %.4e au\n",
	...
	*/
	if( prtflg ) {
		/* (mise en commentaire 2023) */
		/*
		Trace1( "Apparent geocentric longitude %.3f deg",RTD * moonpol[0] );
		Trace1( "   latitude %.3f deg\n", RTD * moonpol[1] );
		Trace1( "Distance %.3f Earth-radii\n", moonpol[2]/Rearth );
		Trace1( "Horizontal parallax" );
		*/
		x = Rearth/moonpol[2];
	...
	/*	x = 180.0 - RTD * arcdot (re, pp); */
		...
		*/
		...
		/* (mise en commentaire 2023) */
		/*
		Trace1( "  Illuminated fraction %.2f\n", x );
		*/
	...
	*/
	...
	/* days per degree of phase angle */
		...
		if( x > 45.0 )
		{
			...
			/*
			if( y > 1.0 ) {
				Trace1( "Phase %.1f days before ", y );
			}
			else {
				Trace1( "Phase %.2f days before ", y );
			}
			*/
			i = (i+1) & 3;
		}
		else
		{
			...
			/*
			if( y > 1.0 ) {
				Trace1( "Phase %.1f days past ", y );
			}
			else {
				Trace1( "Phase %.2f days past ", y );
			}
			*/
		}
		...
		switch(i) {
			case 0: 
				...
				break;
			case 1: 
				Trace1( "Third Quarter\n" ); 
				break;
			case 2: 
				Trace1( "New Moon\n" ); 
				break;
			case 3: 
				Trace1( "First Quarter\n" ); 
				break;
		}
		*/
		/* (mise en commentaire 2023) */
