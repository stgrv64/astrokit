...
DEVICE_USE_MOTOR_ALT,
DEVICE_USE_MOTOR_AZI,
DEVICE_USE_MOTOR_ROT,
LATITUDE,
LONGITUDE,
ALTITUDE,
LED_ETAT_GPIOS,
...
CONFIG_TYPE_INT, // "DEVICE_USE_MOTOR_ALT",
CONFIG_TYPE_INT, // "DEVICE_USE_MOTOR_AZI",
CONFIG_TYPE_INT, // "DEVICE_USE_MOTOR_ROT",
