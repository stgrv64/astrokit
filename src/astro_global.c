...
STRUCT_STR_I2C_ACC_MAG  g_I2cAcc,       *gp_I2c_Acc ;
...
// STRUCT_GPIO_BROCHES     g_Gpio_Broches,     *gp_Gpi_Bro ;
...
STRUCT_GPIO_PARAMS      g_Gpio_Params,      *gp_Gpi_Par ;
STRUCT_PID_PARAMS       g_Pid_Params,       *gp_Pid_Par ;
STRUCT_TIME_PARAMS      g_Time_Params,      *gp_Tim_Par ;
/* OLD / OBSOLETE */
STRUCT_GPIO_PAR_OLD     g_Gpio_Params_Old,  *gp_Gpi_Par_Old ;
...
void GLOBAL_INIT(void) {
  ...
  gp_Gpi_Par     = & g_Gpio_Params ;
  gp_Pid_Par     = & g_Pid_Params ;
  gp_Tim_Pa      = & g_Time_Params ;
  gp_Gpi_Par_Old = & g_Gpio_Params_Old ;
