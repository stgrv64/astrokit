...
typedef enum {
  ...
  PTHREAD_POLICY_2  = 2,
  PTHREAD_POLICY_5  = 5,
  PTHREAD_POLICY_10 = 10,
  PTHREAD_POLICY_50 = 50,
  PTHREAD_POLICY_99 = 99 
}
...
typedef enum {
  ...
  PTHREAD_USLEEP_BEFORE_START_SUIVI_PWM_MOTOR  = 200000,
  PTHREAD_USLEEP_BEFORE_START_SUIVI_MENU       = 5000,
  PTHREAD_USLEEP_BEFORE_START_SUIVI_VOUTE      = 50000,
  PTHREAD_USLEEP_BEFORE_START_SUIVI_INFRA      = 10000,
  PTHREAD_USLEEP_BEFORE_START_SUIVI_LCD        = 10000,
  PTHREAD_USLEEP_BEFORE_START_SUIVI_CLAVIER    = 10000,
  PTHREAD_USLEEP_BEFORE_START_SUIVI_CAPTEUR    = 10000,
  PTHREAD_USLEEP_BEFORE_START_SUIVI_MAIN       = 10000
}
...
typedef enum {
  ...
  PTHREAD_SCHED_PARAM_SUIVI_MENU       = SCHED_RR,
  PTHREAD_SCHED_PARAM_SUIVI_VOUTE      = SCHED_RR,
  PTHREAD_SCHED_PARAM_SUIVI_INFRA      = SCHED_RR,
  PTHREAD_SCHED_PARAM_SUIVI_LCD        = SCHED_RR,
  PTHREAD_SCHED_PARAM_SUIVI_CLAVIER    = SCHED_RR,
  PTHREAD_SCHED_PARAM_SUIVI_CAPTEUR    = SCHED_RR,
  PTHREAD_SCHED_PARAM_SUIVI_MAIN       = SCHED_RR
}
